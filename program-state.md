...
- I1–I3 accepted; I4–I8 pending (I4 runs as llama.cpp-backed CPU variant per G6).
...
| SC-T010 contracts v1.0.0 freeze (I6 prerequisite) | in-progress (subagent) | — | — |
| IL-T004 Scenario C / I4 CPU-variant | in-progress (subagent; assembles I3+IB-T010-E1 evidence, GPU-specific deferred) | — | — |
