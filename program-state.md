...
| FL-T004 goodput profiles + G8 holdout | first pass done (fleetlab@402d260, verified: 159 tests green, commits in-scope; G8 = documented MISS 12.6-20.4% error on the 2-point corpus; leakage guard structural) — RE-FIT in progress: orchestrator's corpus brief omitted the ib-t008 6-point sweep (attribution error mine, agent correctly refused to invent it); richer corpus may fix the latency-profile PENDING + improve holdout | /home/user/fleetlab/reports/holdout-validation.md | fleetlab@402d260 |
